...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-B2WOzQmc.js");
...
const manifest = {
  "33b996b78531eefef8ec57723034c1a97c5aa086a7830a59161b7409824c2f0c": {
    functionName: "createFacultyAccountFn_createServerFn_handler",
    importer: () => import("./faculty-accounts.server-CGyIy9lU.js")
  },
  "69ae95ec14be7f2ae1c1c73f62e03de987970a0bb9e933871d7e4b425d3be20d": {
    functionName: "updateFacultyAccountFn_createServerFn_handler",
    importer: () => import("./faculty-accounts.server-CGyIy9lU.js")
  },
  "82d6c29553d24ad7ed16aba161b29fbaf1d5ce58f395bab1cb92b38cfb8f9da4": {
    functionName: "setFacultyAccountActiveFn_createServerFn_handler",
    importer: () => import("./faculty-accounts.server-CGyIy9lU.js")
  },
  "b86643597b5a0294163b92bbc87d868831b3f7ce1807f17d35cffa90c12daf72": {
    functionName: "listFacultyProfilesFn_createServerFn_handler",
    importer: () => import("./faculty-accounts.server-CGyIy9lU.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-RRLex1WM.js").then((n) => n.r),
    import("./start-8hEHtM0k.js"),
